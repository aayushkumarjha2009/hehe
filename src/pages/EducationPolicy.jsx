...
const acts = [
  {
    title: "Article 58: Homogeinity",
    section: "Section 58 (A) - Uniformity in reporting",
    detail: "In instances where a student has prepared different topics of a chapter at varying levels of depth (e.g., some at JEE Mains level, others at JEE Advanced or beyond), the evaluation shall consider only the <strong>lowest level</strong> of preparation among those topics. This ensures uniformity and fairness in assessment and reporting. Partial or inconsistent depth of preparation across a single chapter shall not be treated as complete advanced-level coverage.",
    subsections: [
      "Curriculum includes Math, Science, and Language proficiency.",
      "Digital tools to supplement learning are highly encouraged.",
    ],
  },
  {
    title: "Article 79: Right to not to spread FOMO",
    section: "Section 79 (D) - FOMO",
    detail: `Students who have completed multiple chapters retain the right to report a lesser number of chapters to avoid creating unnecessary fear of missing out (FOMO) among peers.<br /><br />However, it is mandatory to accurately report the number of completed chapters when required by an authoritative body or institution, especially when a minimum threshold is specified for evaluation or benchmarking purposes.`,
    subsections: [
      "Track chapters completed from coaching institutes.",
      "Individual mentors will be assigned to analyze progress.",
    ],
  },
  {
    title: "Article 109: Equality",
    section: "Section 109 (F) – All students are equal",
    detail: `All students, irrespective of their academic goals — whether preparing for JEE, NEET, ISI, IAT, or any other examination — shall be treated equally under this policy.<br /><br />The reported academic data shall solely reflect the objectively completed chapters and shall not be interpreted as a measure of success probability or comparative advantage.`,
    subsections: [
      "Students can mark completed chapters and see visual progress.",
      "Coaching-specific progress breakdown available.",
    ],
  },
  {
    title: "Article 304: Standardisation",
    section: "Section 304(B) - Topic Title",
    detail: "In the interest of uniformity and ease of understanding, the nomenclature for completed topics has been standardized across the platform.",
    subsections: [
      "No data will be shared with third-party platforms.",
      "Consent will be taken before any future feature update.",
    ],
  },
];
...
export default function EducationPolicy() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white font-[Poppins,sans-serif] px-4 md:px-10 py-20">
      ...
      <div className="max-w-5xl mx-auto mb-12 bg-gradient-to-br from-gray-800 via-gray-900 to-gray-950 border border-gray-700 rounded-2xl shadow-xl p-6 md:p-10 text-center">
        ...
        <a href="#pandu-members" className="inline-block px-6 py-3 text-white bg-gradient-to-r from-cyan-600 to-indigo-700 hover:from-cyan-700 hover:to-indigo-800 transition-all rounded-full shadow-lg hover:scale-105 active:scale-95">
